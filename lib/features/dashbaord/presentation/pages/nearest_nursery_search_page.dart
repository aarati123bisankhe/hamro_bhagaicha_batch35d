...
class _SearchNearestNurseryPageState
  ...
  static const List<_NurserySeed> _seedNurseries = [
    _NurserySeed(
      ...
      area: 'Kalimati, Kathmandu',
      lat: 27.6942,
      lng: 85.3006,
    ),
    _NurserySeed(
      name: 'Kalanki Garden Center',
      area: 'Kalanki, Kathmandu',
      lat: 27.6930,
      lng: 85.2815,
    ),
    _NurserySeed(
      name: 'Rabhibhawan Plant House',
      area: 'Rabhibhawan, Kathmandu',
      lat: 27.6992,
      lng: 85.3001,
    ),
    _NurserySeed(
      name: 'Soltimode Flora Point',
      area: 'Soltimode, Kathmandu',
      lat: 27.7066,
      lng: 85.3011,
    ),
    _NurserySeed(
      name: 'Machagate Nursery',
      area: 'Machagate, Kathmandu',
      lat: 27.7008,
      lng: 85.2924,
    ),
    _NurserySeed(
  ...
  static const Map<String, latlng.LatLng> _knownLocations = {
    'kalimati': latlng.LatLng(27.6942, 85.3006),
    'kalanki': latlng.LatLng(27.6930, 85.2815),
    'bafal': latlng.LatLng(27.6956, 85.2916),
    'rabhibhawan': latlng.LatLng(27.6992, 85.3001),
    'soltimode': latlng.LatLng(27.7066, 85.3011),
    'machagate': latlng.LatLng(27.7008, 85.2924),
  };
